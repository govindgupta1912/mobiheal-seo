      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-semibold text-white">SecureMDM</span>
            </div>
            <p className="mb-6">
              Enterprise-grade mobile device management solutions for businesses of all sizes. Secure your data, manage your devices, and enhance productivity.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-neutral-400 hover:text-white text-xl">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/features#data-encryption" className="hover:text-white">Data Encryption</Link></li>
              <li><Link href="/features#work-profile" className="hover:text-white">Work Profile Container</Link></li>
              <li><Link href="/features#remote-management" className="hover:text-white">Remote Management</Link></li>
              <li><Link href="/features#kiosk-mode" className="hover:text-white">Kiosk Mode</Link></li>
              <li><Link href="/features#app-management" className="hover:text-white">App Management</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/owasp-mobile" className="hover:text-white">OWASP Mobile Top 10</Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <p>&copy; {new Date().getFullYear()} SecureMDM, Inc. All rights reserved.</p>
          </div>
